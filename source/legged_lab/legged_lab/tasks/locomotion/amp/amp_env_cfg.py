...
class AmpSceneCfg(InteractiveSceneCfg):
    ...
    # Head-front RGB-D depth camera (X2 PLAY / viz only for now). Training rough cfg
    # keeps this None so default train does not require ``--enable_cameras``.
    rgbd_head_front: CameraCfg = None
    # lights
